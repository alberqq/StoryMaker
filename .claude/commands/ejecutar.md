...
```
storymaker --proyecto <prj> ejecucion iniciar --coste <N> --iteraciones <N> --modo-ejecucion asistido
```
...
| `Refutacion` | `sm-refutador` |
| `Diseno` | `sm-diseno` |
| `ValidacionCanon` | `sm-validador-canon` |
| `Piloto` / `Produccion` | `sm-redactor`, luego `sm-refinador` |
